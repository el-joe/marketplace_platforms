    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            'vendor_listings' => [
                ...
                'sortableAttributes' => ['price', 'rating_avg', 'total_sold', 'created_at'],
            ...
            'classified_listings' => [
                'filterableAttributes' => ['status', 'classified_category_id', 'price'],
                'sortableAttributes' => ['price', 'created_at'],
                'searchableAttributes' => ['title_en', 'title_ar', 'description_en'],
                'typoTolerance' => ['enabled' => true],
            ],

            'travel_packages' => [
                'filterableAttributes' => ['status'],
                'sortableAttributes' => ['departure_date', 'price'],
                'searchableAttributes' => ['title_en', 'title_ar', 'destination_country', 'destination_city'],
                'typoTolerance' => ['enabled' => true],
            ],
        ],
        'model-settings' => [
