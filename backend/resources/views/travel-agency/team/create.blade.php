...
@section('title', __('travel.team.add_member'))
@section('page-title', __('travel.team.add_member'))
...
@section('content')
    <div class="px-4 py-6 sm:px-6 lg:px-8 max-w-2xl">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">{{ __('travel.team.add_member') }}</h1>
        </div>

        <x-card>
            <form method="POST" action="{{ route('travel-agency.team.store') }}" novalidate>
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <x-form-select name="role_id" label="{{ __('travel.team.role') }}" :select2="true" required>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('travel.team.password') }}
                            <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('travel.team.confirm_password') }}
                            <span class="text-red-500">*</span></label>
