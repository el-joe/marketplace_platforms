                ...
                <tr>
                    ...
                    <td class="px-4 py-2 text-end space-s-2">
                        @if($r->status === 'pending')
                            ...
                            <button class="text-red-600 text-xs" data-refund="1" data-reject="{{ route('admin.coupon-participation-invitations.requests.reject', [$invitation->id, $r->id]) }}">رفض</button>
...
<script>
    document.addEventListener('click', function (e) {
        ...
        const refund = btn.hasAttribute('data-reject') ? (confirm('استرداد الرسوم إلى المحفظة؟') ? 1 : 0) : 1;
        fetch(url, {
            method: 'POST',
