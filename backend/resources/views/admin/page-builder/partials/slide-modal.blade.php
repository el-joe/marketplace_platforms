        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="space-y-1">
                ...
                <div id="slide-desktop-preview" class="hidden mb-2">
                    <img id="slide-desktop-img" src="" alt="{{ __('admin.page_builder.slide_modal.desktop_image') }}" class="w-full h-28 object-cover rounded border border-gray-200">
                    <button type="button" data-clear-image="desktop" class="mt-1 text-xs text-rose-500 hover:text-rose-700">{{ __('admin.page_builder.slide_modal.remove') }}</button>
                </div>
            ...
            <div class="space-y-1">
                ...
                <div id="slide-mobile-preview" class="hidden mb-2">
                    <img id="slide-mobile-img" src="" alt="{{ __('admin.page_builder.slide_modal.mobile_image') }}" class="w-full h-28 object-cover rounded border border-gray-200">
                    <button type="button" data-clear-image="mobile" class="mt-1 text-xs text-rose-500 hover:text-rose-700">{{ __('admin.page_builder.slide_modal.remove') }}</button>
                </div>
                <label class="flex items-center justify-center gap-2 px-3 py-2 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-primary-400 hover:bg-primary-50 transition text-sm text-gray-500">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5"/></svg>
