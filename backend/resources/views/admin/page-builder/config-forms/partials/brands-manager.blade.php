...
<section class="pt-4 mt-4 border-t border-gray-200">
    ...
    <div class="relative mb-3">
        <input type="search"
            ...
            placeholder="{{ __('admin.page_builder.config_forms.brand_strip.add_brand') }}"
            data-action="search-block-brands"
    ...
    <div data-block-brand-search-results data-block-id="{{ $block?->id }}"
    ...
    <div data-block-brands-list data-block-id="{{ $block?->id }}"
