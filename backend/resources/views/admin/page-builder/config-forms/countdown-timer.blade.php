...
<form data-config-form data-block-id="{{ $block?->id }}">
    ...
    <div class="grid grid-cols-2 gap-3 mt-3">
        <x-form.input name="background_color" type="color" label="{{ __('admin.page_builder.config_forms.countdown.background_color') }}" :value="$config['background_color'] ?? '#1f2937'" />
