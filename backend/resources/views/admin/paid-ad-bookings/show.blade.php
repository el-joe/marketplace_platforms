                ...
                <dl class="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <dd class="font-semibold">
                            {{ $paidAdBooking->total_charged ? number_format($paidAdBooking->total_charged, 2) . ' ' . strtoupper($paidAdBooking->currency ?? 'USD') : '—' }}
                        </dd>
                    </div>
                    <div>
                ...
                @if($paidAdBooking->slot)
                    <dl class="space-y-2 text-sm">
                        ...
                        <div>
                            ...
                            <dd>{{ number_format($paidAdBooking->slot->base_rate ?? 0, 2) }} {{ strtoupper($paidAdBooking->currency ?? 'USD') }}</dd>
                        </div>
                        <div class="pt-2">
