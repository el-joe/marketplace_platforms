    ...
    private function productRowFlashSale(array $cfg, int $maxProducts, Country $country): array
    {
        ...
        $submissions = FlashSaleSubmission::where('flash_sale_id', $cfg['flash_sale_id'])
            ...
            ->with([
                ...
                'vendorListing.primaryShippingMethod:id,badge_label_en,badge_label_ar,badge_color_hex,badge_text_color_hex,badge_image_path,min_delivery_days,max_delivery_days,is_express_type,badge_show_delivery_time,badge_delivery_text_en,badge_delivery_text_ar',
