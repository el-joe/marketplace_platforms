...
class ListingQueryService
{
    ...
    public function toCardShape(
        ...
        return [
            ...
            'images' => $imagesSlider,
            'name' => $this->customerVariantNamePair($variant, $product),
            'name_en' => $this->customerVariantNamePair($variant, $product)['en'],
            'name_ar' => $this->customerVariantNamePair($variant, $product)['ar'],
    ...
    public function paginateMixed(Country $country, array $types, ?array $categoryIds, array $filters, int $page, int $perPage, array $wishlistIds): array
    {
        ...
        $models = [];
        foreach ([
            'admin' => [AdminListing::class, ['primaryShippingMethod:id,badge_label_en,badge_label_ar,badge_color_hex,badge_text_color_hex,badge_icon_color_hex,badge_image_path,min_delivery_days,max_delivery_days,is_express_type,badge_show_delivery_time,badge_delivery_text_en,badge_delivery_text_ar,badge_icon']],
            'vendor' => [VendorListing::class, ['vendor:id,store_name,store_rating_avg', 'primaryShippingMethod:id,badge_label_en,badge_label_ar,badge_color_hex,badge_text_color_hex,badge_icon_color_hex,badge_image_path,min_delivery_days,max_delivery_days,is_express_type,badge_show_delivery_time,badge_delivery_text_en,badge_delivery_text_ar,badge_icon']],
