...
class PackagingOrderDelivered extends BaseDatabaseBroadcastNotification
{
    public function __construct(private readonly PackagingSupplyRequest $packagingRequest) {}

    public function notificationType(): string
    {
        return 'packaging_order_delivered';
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title'          => 'Packaging Order Delivered',
            'body'           => "Your packaging order #{$this->packagingRequest->request_number} has been delivered. Enjoy!",
