...
class PackagingOrderShipped extends BaseDatabaseBroadcastNotification
{
    public function __construct(private readonly PackagingSupplyRequest $packagingRequest) {}

    public function notificationType(): string
    {
        return 'packaging_order_shipped';
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title'          => 'Packaging Order Shipped',
            'body'           => "Your packaging order #{$this->packagingRequest->request_number} has been shipped to your address.",
