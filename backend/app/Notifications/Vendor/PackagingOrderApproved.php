...
class PackagingOrderApproved extends BaseDatabaseBroadcastNotification
{
    public function __construct(private readonly PackagingSupplyRequest $packagingRequest) {}

    public function notificationType(): string
    {
        return 'packaging_order_approved';
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title'          => 'Packaging Order Approved',
            'body'           => "Your packaging order #{$this->packagingRequest->request_number} has been approved and is being prepared.",
