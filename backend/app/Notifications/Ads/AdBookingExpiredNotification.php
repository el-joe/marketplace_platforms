...
class AdBookingExpiredNotification extends BaseDatabaseBroadcastNotification
{
    ...
    {
        return 'ad_booking_expired';
    }

    public function notificationData(object $notifiable): array
    {
        return [
            'title' => __('notifications.ads.booking_expired.title'),
            'message' => __('notifications.ads.booking_expired.message', [
