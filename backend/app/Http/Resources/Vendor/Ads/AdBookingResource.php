...
class AdBookingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'subscription_charged' => $this->subscription_charged,
            'total_spend' => $this->total_spend,
            'clicks_delivered' => $this->clicks_delivered,
            'impressions_delivered' => $this->impressions_delivered,
            'effective_cpc' => $this->effective_cpc,
            'effective_cpm' => $this->effective_cpm,
