...
class SellerListingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'delivery_estimate' => $this->fulfillment_model?->value === 'fbn' ? '1-2 days' : '3-7 days',
            'delivery_badge' => $this->whenLoaded('primaryShippingMethod', fn () => $this->primaryShippingMethod ? [
                ...
                'icon_color_hex' => $this->primaryShippingMethod->badge_icon_color_hex,
                ...
                'badge_image_url' => $this->primaryShippingMethod->badge_image_url,
