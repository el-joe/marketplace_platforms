...
class ClassifiedListingDetailResource extends JsonResource
{
    ...
    public ?ExclusiveContract $exclusiveContract = null;
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'exclusive_contract' => $this->exclusiveContract ? [
                'marketer' => [
                    'id' => $this->exclusiveContract->marketer?->id,
                    'name' => $this->exclusiveContract->marketer?->name,
                ],
                'expires_at' => $this->exclusiveContract->ends_at?->toIso8601String(),
            ] : null,
