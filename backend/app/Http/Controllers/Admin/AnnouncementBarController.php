...
class AnnouncementBarController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'bg_color_hex' => ['nullable', 'string', 'regex:/^#[0-9A-Fa-f]{6}$/'],
            'text_color_hex' => ['nullable', 'string', 'regex:/^#[0-9A-Fa-f]{6}$/'],
        ...
        $bar = AnnouncementBar::create([
            ...
            'bg_color_hex' => $data['bg_color_hex'] ?? null,
            'text_color_hex' => $data['text_color_hex'] ?? null,
