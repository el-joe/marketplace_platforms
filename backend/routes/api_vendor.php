...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['vendor.auth', 'vendor.active'])->group(function (): void {
        ...
        Route::middleware('vendor.onboarded')->group(function (): void {
            ...
            Route::prefix('coupon-participation')->name('vendor.coupon-participation.')->group(function (): void {
                ...
                Route::post('{invitation}/requests', [CouponParticipationController::class, 'store'])->name('store');
            });
