        ...
        return [
            'general' => [
                'platform' => [
                    ...
                    'platform_logo_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,svg,webp,avif', 'max_size_kb' => 500],
            ...
            'homepage' => [
                'hero' => [
                    ...
                    'home_hero_bg_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,webp,avif', 'max_size_kb' => 2000],
                ...
                'app_download' => [
                    ...
                    'app_download_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,webp,avif'],
            ...
            'footer' => [
                'main' => [
                    ...
                    'footer_logo_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,svg,webp,avif'],
                ],
                'social_links' => [
                ...
                'payments_badges' => [
                    'payment_badges_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,svg,webp,avif'],
            ...
            'auth_pages' => [
                'login' => [
                    ...
                    'login_page_bg_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,webp,avif'],
                ],
                'register' => [
            ...
            'vendor_portal' => [
                'landing' => [
                    ...
                    'vendor_portal_hero_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,webp,avif'],
                ...
                'onboarding' => [
                    ...
                    'vendor_onboarding_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,webp,avif'],
                ],
                'support' => [
                    ...
                    'vendor_portal_logo_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,svg,webp,avif'],
                ],
            ],

            'emails' => [
                'general' => [
                    'email_header_logo_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,svg,webp,avif', 'max_size_kb' => 200],
            ...
            'seo' => [
                'defaults' => [
                    ...
                    'seo_og_image_file' => ['type' => 'file', 'allowed_extensions' => 'jpg,jpeg,png,webp,avif', 'max_size_kb' => 1000],
