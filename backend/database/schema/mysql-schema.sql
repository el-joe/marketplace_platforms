...
CREATE TABLE `ad_image_items` (
  ...
  `subtitle_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subtitle_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `badge_label_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `badge_label_ar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ad_support_articles` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ad_support_collection_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `author_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `excerpt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Short summary — also used as the meta description on the portal',
  `excerpt_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `excerpt_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Full article body — HTML from a rich text editor',
  `body_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `body_ar` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `ad_support_collections` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `parent_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Supports one level of sub-collections — a collection with a parent cannot itself be a parent (enforce at app layer, not DB constraint, for simplicity)',
  ...
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Icon URL shown on the collection card, e.g. an intercom.help svg icon link',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `addresses` (
  ...
  `addressable_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `address_type` enum('home','work','shipping','billing','both') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `admin_listings` (
  ...
  `fulfillment_model` enum('fbm','fbn','cross_dock') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'fbn' COMMENT 'Always fbn — enforced by model boot, no form field',
  `global_system_type` enum('express_fbn','merchant_fbp','marketplace') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'express_fbn' COMMENT 'Always express_fbn — enforced by model boot',
  `primary_shipping_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status` enum('active','paused','out_of_stock','archived') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `campaign_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `sold_by_label_en` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Nawy' COMMENT 'Shown on PDP as "Sold by [name]". Default = platform name.',
  `sold_by_label_ar` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'نوي',
  `express_badge_label_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Noon Express' COMMENT 'Yellow Express badge label — always present, label customisable',
  `express_badge_label_ar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'نون إكسبرس',
  ...
  `weight_class` enum('light','medium','heavy') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Display only: light ≤1000g, medium 1001–5000g, heavy >5000g',
  `handling_class` enum('standard','refrigerated','fragile','special_tech') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'standard',
...
CREATE TABLE `advertise_inquiries` (
  ...
  `status` enum('new','contacted','closed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `affiliate_promo_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `affiliate_promo_codes` (
  ...
  `value` decimal(10,2) NOT NULL COMMENT 'Percentage (e.g. 10.00 = 10%) or fixed amount in currency smallest unit, depending on type',
  `currency` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null means applies regardless of order currency',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `affiliate_promo_codes_code_unique` (`code`),
  KEY `affiliate_promo_codes_marketer_id_foreign` (`marketer_id`),
  KEY `affiliate_promo_codes_code_index` (`code`),
  KEY `affiliate_promo_codes_is_active_index` (`is_active`),
  CONSTRAINT `affiliate_promo_codes_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ai_feature_credits` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_type` enum('vendor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `feature` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '''image_enhancement'', ''virtual_tryon'', ''video_generation''',
...
CREATE TABLE `ai_image_enhancement_jobs` (
  ...
  `original_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `enhanced_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('queued','processing','completed','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued',
  `provider` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Which AI service was used',
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `requested_by_type` enum('vendor','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requested_by_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ai_video_generation_jobs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requested_by_type` enum('vendor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requested_by_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `result_video_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `app_bottom_nav_items` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `app_context_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `position` tinyint NOT NULL,
  `nav_type` enum('home','categories','featured','account','cart','custom') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `label_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `label_ar` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `icon_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `deep_link` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `app_context_countries` (
  ...
  `app_context_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `home_page_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `attribute_values` (
  ...
  `swatch_image_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `banner_placement_definitions` (
  ...
  `mobile_width_px` int unsigned DEFAULT NULL,
  `mobile_height_px` int unsigned DEFAULT NULL,
...
CREATE TABLE `blog_categories` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `parent_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Supports one level of sub-categories — a category with a parent cannot itself be a parent (enforce at app layer, not DB constraint, for simplicity)',
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `color_hex` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brand accent color for this category, e.g. #3B82F6 — used for category pill/badge on the portal',
  `icon_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Heroicon or similar name for category badge',
...
CREATE TABLE `blog_posts` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `blog_category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `author_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL slug — shared across both languages, language is determined by the portal request locale',
  `excerpt_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Short summary shown on listing cards, max 300 chars',
  `excerpt_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Full article body — HTML from a rich text editor',
  `body_ar` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `featured_image_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Hero image shown at top of post and on listing cards',
  `featured_image_alt_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `featured_image_alt_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `seo_description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `seo_description_ar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `og_image_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Social share image — may differ from featured_image',
  `views_count` int unsigned NOT NULL DEFAULT '0',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `bookable_unit_availability`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bookable_unit_availability` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bookable_unit_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `is_available` tinyint(1) NOT NULL DEFAULT '1',
  `capacity_override` int unsigned DEFAULT NULL,
  `price_day_only` bigint unsigned DEFAULT NULL,
  `price_with_overnight` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bookable_unit_availability_bookable_unit_id_date_unique` (`bookable_unit_id`,`date`),
  CONSTRAINT `bookable_unit_availability_bookable_unit_id_foreign` FOREIGN KEY (`bookable_unit_id`) REFERENCES `bookable_units` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `bookable_unit_reservations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bookable_unit_reservations` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reservation_number` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bookable_unit_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `confirmed_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `confirmed_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bookable_unit_reservations_reservation_number_unique` (`reservation_number`),
  KEY `bookable_unit_reservations_customer_id_foreign` (`customer_id`),
  KEY `bookable_unit_reservations_time_slot_id_foreign` (`time_slot_id`),
  KEY `bookable_unit_reservations_unit_dates_idx` (`bookable_unit_id`,`date_from`,`date_to`),
  KEY `bookable_unit_reservations_confirmed_by_admin_id_foreign` (`confirmed_by_admin_id`),
  CONSTRAINT `bookable_unit_reservations_bookable_unit_id_foreign` FOREIGN KEY (`bookable_unit_id`) REFERENCES `bookable_units` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bookable_unit_reservations_confirmed_by_admin_id_foreign` FOREIGN KEY (`confirmed_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  CONSTRAINT `bookable_unit_reservations_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bookable_unit_reservations_time_slot_id_foreign` FOREIGN KEY (`time_slot_id`) REFERENCES `bookable_unit_time_slots` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `bookable_unit_time_slots`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bookable_unit_time_slots` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bookable_unit_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slot_type` enum('morning','evening','custom') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'custom',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bookable_unit_time_slots_bookable_unit_id_foreign` (`bookable_unit_id`),
  CONSTRAINT `bookable_unit_time_slots_bookable_unit_id_foreign` FOREIGN KEY (`bookable_unit_id`) REFERENCES `bookable_units` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bookable_units` (
  ...
  `type` enum('chalet','hotel_room','apartment','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'chalet',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bookable_units_approved_by_admin_id_foreign` (`approved_by_admin_id`),
  KEY `bookable_units_travel_agency_id_status_index` (`travel_agency_id`,`status`),
  CONSTRAINT `bookable_units_approved_by_admin_id_foreign` FOREIGN KEY (`approved_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  CONSTRAINT `bookable_units_travel_agency_id_foreign` FOREIGN KEY (`travel_agency_id`) REFERENCES `travel_agencies` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `brands` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `has_authenticity_guarantee` tinyint(1) NOT NULL DEFAULT '0',
  `manufacturer_warranty_months` int unsigned DEFAULT NULL,
  `authenticity_notes_en` text COLLATE utf8mb4_unicode_ci,
  `authenticity_notes_ar` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `carrier_claims` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `claim_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipment_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_company_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_agent_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `claim_type` enum('lost','damaged','delayed','wrong_item','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `claimed_amount` bigint unsigned NOT NULL,
  `evidence_files` json DEFAULT NULL,
  `status` enum('submitted','under_review','approved','rejected','compensated') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'submitted',
  `resolution_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `compensated_amount` bigint unsigned DEFAULT NULL,
  `resolved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `carrier_performance_ratings` (
  ...
  `rated_by_type` enum('customer','vendor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rated_by_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cart_card_offers` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `card_name_en` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `card_name_ar` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_name_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_name_ar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_image_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cashback_type` enum('percentage','fixed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cashback_pct` decimal(5,2) NOT NULL DEFAULT '0.00',
  `cashback_fixed_amount` bigint unsigned NOT NULL DEFAULT '0',
  `label_template_en` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Earn {amount} CA$HBACK with {card_name}',
  `label_template_ar` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apply_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `apply_label_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Apply',
  `apply_label_ar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'قدم الآن',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cart_item_custom_attribute_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cart_item_custom_attribute_values` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cart_item_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_custom_attribute_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `value` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cicav_product_custom_attribute_id_fk` (`product_custom_attribute_id`),
  KEY `cart_item_custom_attribute_values_cart_item_id_index` (`cart_item_id`),
  CONSTRAINT `cart_item_custom_attribute_values_cart_item_id_foreign` FOREIGN KEY (`cart_item_id`) REFERENCES `cart_items` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cicav_product_custom_attribute_id_fk` FOREIGN KEY (`product_custom_attribute_id`) REFERENCES `product_custom_attributes` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cart_items` (
  ...
  `selected_shipping_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `warranty_plan_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quantity` int NOT NULL,
  ...
  KEY `cart_items_marketer_listing_id_index` (`marketer_listing_id`),
  ...
  CONSTRAINT `cart_items_marketer_listing_id_foreign` FOREIGN KEY (`marketer_listing_id`) REFERENCES `marketer_listings` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `carts` (
  ...
  `affiliate_promo_code_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `carts_affiliate_promo_code_id_index` (`affiliate_promo_code_id`),
  CONSTRAINT `carts_affiliate_promo_code_id_foreign` FOREIGN KEY (`affiliate_promo_code_id`) REFERENCES `affiliate_promo_codes` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `classified_attribute_definitions` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Machine key stored in listings.attributes JSON — e.g. "year", "brand", "km"',
  `label_en` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `label_ar` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `input_type` enum('text','number','select','boolean') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
  `options` json DEFAULT NULL COMMENT 'For select: [{"value":"new","label_en":"New","label_ar":"جديد"},…]',
  `unit_en` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_ar` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `classified_categories` (
  ...
  `contract_template_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `classified_category_attribute_map` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `classified_category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `classified_attribute_definition_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `classified_inquiries` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `classified_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `classified_listing_attachments` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `classified_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `attachment_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `classified_listings` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `listing_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `seller_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `city_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `listing_purpose` enum('sale','rent') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_ar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `sketch_file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('draft','pending_contract','pending_review','active','paused','sold','expired','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `contract_template_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contract_accepted_at` timestamp NULL DEFAULT NULL,
  `contract_signature_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  ...
  `vendor_listing_reference` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `classified_wanted_listings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `classified_wanted_listings` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `description_ar` text COLLATE utf8mb4_unicode_ci,
  `budget_min` bigint unsigned DEFAULT NULL COMMENT 'BIGINT base-currency. No /100.',
  `budget_max` bigint unsigned DEFAULT NULL COMMENT 'BIGINT base-currency. No /100.',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `classified_wanted_listings_listing_number_unique` (`listing_number`),
  KEY `classified_wanted_listings_classified_category_id_foreign` (`classified_category_id`),
  KEY `classified_wanted_listings_country_id_foreign` (`country_id`),
  KEY `classified_wanted_listings_city_id_foreign` (`city_id`),
  KEY `classified_wanted_listings_marketer_id_status_index` (`marketer_id`,`status`),
  CONSTRAINT `classified_wanted_listings_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE SET NULL,
  CONSTRAINT `classified_wanted_listings_classified_category_id_foreign` FOREIGN KEY (`classified_category_id`) REFERENCES `classified_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `classified_wanted_listings_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`),
  CONSTRAINT `classified_wanted_listings_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `countries` (
  ...
  `cod_available` tinyint(1) NOT NULL DEFAULT '0',
  `cod_max_amount` int unsigned NOT NULL DEFAULT '0',
  `cod_supermall_max_amount` int unsigned NOT NULL DEFAULT '0',
  `cod_supermall_category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `countries_cod_supermall_category_id_foreign` (`cod_supermall_category_id`),
  CONSTRAINT `countries_cod_supermall_category_id_foreign` FOREIGN KEY (`cod_supermall_category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `country_payment_gateways` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gateway_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name_ar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `webhook_secret_encrypted` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `last_verification_status` enum('success','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_verification_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `coupon_marketers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coupon_marketers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `coupon_marketers_coupon_id_marketer_id_unique` (`coupon_id`,`marketer_id`),
  KEY `coupon_marketers_marketer_id_foreign` (`marketer_id`),
  CONSTRAINT `coupon_marketers_coupon_id_foreign` FOREIGN KEY (`coupon_id`) REFERENCES `coupons` (`id`) ON DELETE CASCADE,
  CONSTRAINT `coupon_marketers_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `coupon_participation_invitations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coupon_participation_invitations` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `coupon_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `max_participants` int unsigned NOT NULL,
  `min_fee_amount` bigint unsigned NOT NULL,
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `registration_deadline` timestamp NOT NULL,
  `status` enum('open','closed','fulfilled','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `created_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `coupon_participation_invitations_coupon_id_foreign` (`coupon_id`),
  KEY `coupon_participation_invitations_created_by_admin_id_foreign` (`created_by_admin_id`),
  KEY `coupon_participation_invitations_status_index` (`status`),
  CONSTRAINT `coupon_participation_invitations_coupon_id_foreign` FOREIGN KEY (`coupon_id`) REFERENCES `coupons` (`id`) ON DELETE SET NULL,
  CONSTRAINT `coupon_participation_invitations_created_by_admin_id_foreign` FOREIGN KEY (`created_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `coupon_participation_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coupon_participation_requests` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `invitation_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `participant_type` enum('vendor','marketer') COLLATE utf8mb4_unicode_ci NOT NULL,
  `participant_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `offered_fee_amount` bigint unsigned NOT NULL,
  `payment_method` enum('wallet','bank_transfer') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'wallet',
  `bank_transfer_proof_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cpr_invitation_participant_unique` (`invitation_id`,`participant_type`,`participant_id`),
  KEY `cpr_participant_index` (`participant_type`,`participant_id`),
  KEY `coupon_participation_requests_reviewed_by_admin_id_foreign` (`reviewed_by_admin_id`),
  CONSTRAINT `coupon_participation_requests_invitation_id_foreign` FOREIGN KEY (`invitation_id`) REFERENCES `coupon_participation_invitations` (`id`) ON DELETE CASCADE,
  CONSTRAINT `coupon_participation_requests_reviewed_by_admin_id_foreign` FOREIGN KEY (`reviewed_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coupon_usages` (
  ...
  `status` enum('reserved','consumed','released') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'consumed' COMMENT 'reserved at placement, consumed on payment capture/COD delivery, released on any rollback path (decrements coupons.times_used).',
  ...
  KEY `coupon_usages_coupon_id_status_index` (`coupon_id`,`status`),
  KEY `coupon_usages_coupon_customer_index` (`coupon_id`,`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `coupon_vendors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coupon_vendors` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `coupon_vendors_coupon_id_vendor_id_unique` (`coupon_id`,`vendor_id`),
  KEY `coupon_vendors_vendor_id_foreign` (`vendor_id`),
  CONSTRAINT `coupon_vendors_coupon_id_foreign` FOREIGN KEY (`coupon_id`) REFERENCES `coupons` (`id`) ON DELETE CASCADE,
  CONSTRAINT `coupon_vendors_vendor_id_foreign` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coupons` (
  ...
  `funded_by` enum('platform','vendor','shared') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
...
CREATE TABLE `custom_page_category_map` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `custom_page_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sort_order` smallint unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `custom_pages` (
  ...
  `listing_types` json DEFAULT NULL COMMENT 'Allowed listing sources (admin|vendor|marketer). NULL = all.',
  `all_categories` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'When true, no category restriction; linked categories are ignored.',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `seo_title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seo_title_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seo_description_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seo_description_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `customer_special_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `customer_special_requests` (
  ...
  `description_ar` text COLLATE utf8mb4_unicode_ci,
  `budget` bigint DEFAULT NULL COMMENT 'Customer''s budget. BIGINT base-currency. No /100.',
  ...
  `brokers_notified` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Count of brokers auto-notified on creation',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `customer_special_requests_city_id_foreign` (`city_id`),
  KEY `customer_special_requests_category_id_city_id_status_index` (`category_id`,`city_id`,`status`),
  KEY `csr_customer_status_idx` (`customer_id`,`status`),
  CONSTRAINT `customer_special_requests_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `customer_special_requests_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE SET NULL,
  CONSTRAINT `customer_special_requests_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customers` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `locale` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ar',
  ...
  `status` enum('active','suspended','banned','deleted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
...
CREATE TABLE `delivery_agent_cod_settlements` (
  ...
  `status` enum('pending','settled','disputed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `discrepancy_resolution` enum('pending','deducted_from_earnings','written_off','vendor_chargeback') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `delivery_agent_documents` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `agent_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `document_type` enum('national_id','driving_license','vehicle_registration','insurance','profile_photo') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `delivery_agent_earnings` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `agent_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `delivery_assignment_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `earning_type` enum('base_fee','cod_handling','bonus','tip','deduction') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `delivery_agent_payouts` (
  ...
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','approved','paid','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `delivery_agent_shifts` (
  ...
  `status` enum('scheduled','active','completed','no_show','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scheduled',
  `total_deliveries` int NOT NULL DEFAULT '0',
...
CREATE TABLE `delivery_agents` (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('active','inactive','on_shift','suspended') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `agent_type` enum('platform','third_party') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
  `shipping_company_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'NULL = platform-employed agent',
  `added_by_supervisor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_type` enum('motorcycle','car','van','bicycle') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'motorcycle',
  `vehicle_plate` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `delivery_assignments` (
  ...
  `sub_order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `agent_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('assigned','accepted','picked_up','delivered','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assigned',
  `assigned_at` timestamp NOT NULL,
  `accepted_at` timestamp NULL DEFAULT NULL,
  `picked_up_at` timestamp NULL DEFAULT NULL,
  `delivered_at` timestamp NULL DEFAULT NULL,
  `failed_at` timestamp NULL DEFAULT NULL,
  `failure_reason` enum('customer_not_home','wrong_address','customer_refused','damaged_package','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `failure_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `cod_settlement_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `customer_rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Written by customer or delivery agent on customer behalf',
...
CREATE TABLE `device_tokens` (
  ...
  `platform` enum('ios','android','web') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `exclusive_contracts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `exclusive_contracts` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The marketer this open-market exclusive contract is granted to.',
  `classified_category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null = applies to all classified categories.',
  `classified_listing_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null = applies to the whole category rather than one specific listing.',
  `starts_at` timestamp NOT NULL,
  `ends_at` timestamp NOT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT 'pending | active | expired | revoked',
  `contract_file_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Admin who created this exclusive contract.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `exclusive_contracts_created_by_foreign` (`created_by`),
  KEY `exclusive_contracts_listing_status_idx` (`classified_listing_id`,`status`),
  KEY `exclusive_contracts_category_status_idx` (`classified_category_id`,`status`),
  KEY `exclusive_contracts_marketer_idx` (`marketer_id`),
  CONSTRAINT `exclusive_contracts_classified_category_id_foreign` FOREIGN KEY (`classified_category_id`) REFERENCES `classified_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `exclusive_contracts_classified_listing_id_foreign` FOREIGN KEY (`classified_listing_id`) REFERENCES `classified_listings` (`id`) ON DELETE CASCADE,
  CONSTRAINT `exclusive_contracts_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  CONSTRAINT `exclusive_contracts_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `faqs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `context` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'seller',
...
CREATE TABLE `fbn_daily_overage_fees` (
  ...
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','invoiced','paid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fbn_inbound_requests` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vendor_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `warehouse_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` enum('draft','submitted','approved','shipped','received','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `admin_approved_by` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `fbn_storage_fees` (
  ...
  `declared_weight_grams` int unsigned DEFAULT NULL,
  `volumetric_weight_grams` int unsigned DEFAULT NULL,
  `chargeable_weight_grams` int unsigned DEFAULT NULL,
  `free_days_applied` int unsigned DEFAULT NULL,
  `days_in_storage` int unsigned DEFAULT NULL,
  `within_free_period` tinyint(1) NOT NULL DEFAULT '0',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `flash_sale_marketer_invitations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `flash_sale_marketer_invitations` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `flash_sale_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `extra_commission_rate` decimal(5,2) DEFAULT NULL,
  `extra_commission_mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage',
  `extra_commission_flat_amount` bigint unsigned DEFAULT NULL,
  `invited_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `responded_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `flash_sale_marketer_invitations_flash_sale_id_marketer_id_unique` (`flash_sale_id`,`marketer_id`),
  KEY `flash_sale_marketer_invitations_marketer_id_foreign` (`marketer_id`),
  KEY `flash_sale_marketer_invitations_invited_by_admin_id_foreign` (`invited_by_admin_id`),
  CONSTRAINT `flash_sale_marketer_invitations_flash_sale_id_foreign` FOREIGN KEY (`flash_sale_id`) REFERENCES `flash_sales` (`id`) ON DELETE CASCADE,
  CONSTRAINT `flash_sale_marketer_invitations_invited_by_admin_id_foreign` FOREIGN KEY (`invited_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  CONSTRAINT `flash_sale_marketer_invitations_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `flight_bookings` (
  ...
  `total_price` bigint unsigned NOT NULL COMMENT 'BIGINT base-currency.',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','confirmed','cancelled','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  ...
  KEY `flight_bookings_travel_agency_id_foreign` (`travel_agency_id`),
  KEY `flight_bookings_customer_id_status_index` (`customer_id`,`status`),
  CONSTRAINT `flight_bookings_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`),
  CONSTRAINT `flight_bookings_travel_agency_id_foreign` FOREIGN KEY (`travel_agency_id`) REFERENCES `travel_agencies` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `footer_links` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `group` enum('social','bottom_nav','app_store','payment_method') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `footer_links_group_sort_order_index` (`group`,`sort_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `frequently_bought_together_items` (
  `product_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `related_product_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `gift_card_batches` (
  ...
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Card design image URL shown on storefront',
...
CREATE TABLE `gift_card_purchases` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gift_card_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'One purchase per gift card — 1:1 relationship.',
  `gift_card_batch_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The order placed to buy this gift card.',
  `buyer_customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `recipient_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `gift_card_transactions` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gift_card_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` bigint NOT NULL,
  `balance_after` bigint NOT NULL,
  `type` enum('issuance','redemption','refund','admin_adjustment','expiry') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `performed_by_customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `performed_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `gift_cards` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gift_card_batch_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source` enum('batch','purchased','gifted','refund_credit') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'batch',
  ...
  `currency_code` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('inactive','active','redeemed','expired') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
  `redeemed_by_customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `issued_to_customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'If set, only this customer can redeem this card.',
  `purchased_by_customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Customer who paid for this card. NULL = admin-generated, not purchased.',
  `recipient_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Email to deliver code+PIN to. NULL = deliver to buyer.',
  `recipient_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchase_order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'The orders.id where this gift card was purchased.',
...
CREATE TABLE `help_center_articles` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `help_center_category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `author_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Matches countries.site_code (the {country} portal route segment). Null = shown for every country.',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `help_center_categories` (
  ...
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_ar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Icon URL shown on the category card (defaults to a noon-style svg icon)',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `inventory_movements` (
  ...
  `reference_type` enum('order','inbound_shipment','transfer','adjustment','return','sub_order','campaign_sample','warranty_replacement','rto') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reference_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ledger_entries` (
  ...
  `account_type` enum('customer_payment','platform_revenue','platform_commission','seller_payable','gateway_fee','tax_payable','refund_liability','shipping_revenue','cod_clearing','marketer_commission_payable','marketer_payable','carrier_payable','warranty_revenue','coupon_expense','shipping_subsidy_expense','wallet_liability') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `live_stream_comments` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `live_stream_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `live_stream_likes` (
  ...
  `live_stream_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `guest_token` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Fingerprint for unauthenticated likes',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `live_streams` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_en` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_ar` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_ar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `thumbnail_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('scheduled','live','ended') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scheduled',
  ...
  `stream_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Random key used as WebRTC room ID',
  `created_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_ad_package_subscriptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_ad_package_subscriptions` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `package_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` bigint unsigned NOT NULL COMMENT 'Snapshot of package price (ex-VAT). BIGINT.',
  `vat_pct` tinyint unsigned NOT NULL COMMENT 'Snapshot of VAT percentage',
  `duration_days` int unsigned NOT NULL COMMENT 'Snapshot of package duration',
  `amount_paid` bigint unsigned NOT NULL COMMENT 'BIGINT = price + vat_amount. No /100.',
  `vat_amount` bigint unsigned NOT NULL COMMENT 'BIGINT. No /100.',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_method` enum('wallet','bank_transfer','online') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'wallet',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `marketer_ad_package_subscriptions_package_id_foreign` (`package_id`),
  KEY `marketer_ad_package_subscriptions_marketer_id_status_index` (`marketer_id`,`status`),
  KEY `marketer_ad_package_subscriptions_status_expires_at_index` (`status`,`expires_at`),
  CONSTRAINT `marketer_ad_package_subscriptions_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_ad_package_subscriptions_package_id_foreign` FOREIGN KEY (`package_id`) REFERENCES `marketer_ad_packages` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_ad_packages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_ad_packages` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_ar` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_ar` text COLLATE utf8mb4_unicode_ci,
  `price` bigint unsigned NOT NULL COMMENT 'BIGINT base-currency. No /100.',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vat_pct` tinyint unsigned NOT NULL DEFAULT '15' COMMENT 'VAT percentage 0-100',
  `target_type` enum('influencer','affiliate','broker','all') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
  `duration_days` int unsigned NOT NULL,
  `features` json DEFAULT NULL COMMENT 'Array of feature strings shown in package UI',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_campaign_category_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_campaign_category_rules` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_campaign_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The campaign this include/exclude rule belongs to.',
  `category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Product Category — set when this rule is a product-category rule (mutually exclusive with classified_category_id).',
  `classified_category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Open-market ClassifiedCategory — set when this rule is a classified-category rule (mutually exclusive with category_id).',
  `mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'include | exclude — must match the owning campaign''s corresponding *_category_selection_mode.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `marketer_campaign_category_rules_category_id_foreign` (`category_id`),
  KEY `marketer_campaign_category_rules_classified_category_id_foreign` (`classified_category_id`),
  KEY `mccr_campaign_category_idx` (`marketer_campaign_id`,`category_id`),
  KEY `mccr_campaign_classified_category_idx` (`marketer_campaign_id`,`classified_category_id`),
  CONSTRAINT `marketer_campaign_category_rules_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_campaign_category_rules_classified_category_id_foreign` FOREIGN KEY (`classified_category_id`) REFERENCES `classified_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_campaign_category_rules_marketer_campaign_id_foreign` FOREIGN KEY (`marketer_campaign_id`) REFERENCES `marketer_campaigns` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `marketer_campaign_conversions` (
  ...
  `invitation_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_item_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `travel_booking_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Set for travel campaign conversions',
  `classified_inquiry_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Set for classified campaign conversions',
  `conversion_type` enum('product_sale','travel_booking','classified_inquiry') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product_sale',
  ...
  `status` enum('pending','approved','reversed','paid') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `approved_at` timestamp NULL DEFAULT NULL,
  ...
  `flash_sale_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `flash_sale_bonus_amount` bigint DEFAULT NULL COMMENT 'Base-currency integer bonus commission earned during a flash sale window, on top of commission_amount.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `marketer_campaign_conversions_flash_sale_id_foreign` (`flash_sale_id`),
  ...
  CONSTRAINT `marketer_campaign_conversions_flash_sale_id_foreign` FOREIGN KEY (`flash_sale_id`) REFERENCES `flash_sales` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `marketer_campaign_invitations` (
  ...
  `campaign_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','accepted','rejected','timed_out','replaced','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `acceptance_window_hours` smallint unsigned NOT NULL DEFAULT '12',
  `expires_at` timestamp NULL DEFAULT NULL,
  `responded_at` timestamp NULL DEFAULT NULL,
  `marketer_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `decline_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `referral_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referral_link` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qr_code_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `whatsapp_sent` tinyint(1) NOT NULL DEFAULT '0',
  `whatsapp_sent_at` timestamp NULL DEFAULT NULL,
  `replaced_invitation_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `platform_fee_currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `platform_fee_status` enum('not_applicable','pending','paid','waived') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_applicable' COMMENT 'not_applicable = affiliate type (always free)',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_campaign_sample_custom_attribute_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_campaign_sample_custom_attribute_values` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_campaign_sample_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_custom_attribute_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `mcscav_product_custom_attribute_id_fk` (`product_custom_attribute_id`),
  KEY `mcscav_sample_id_idx` (`marketer_campaign_sample_id`),
  CONSTRAINT `mcscav_product_custom_attribute_id_fk` FOREIGN KEY (`product_custom_attribute_id`) REFERENCES `product_custom_attributes` (`id`) ON DELETE SET NULL,
  CONSTRAINT `mcscav_sample_id_fk` FOREIGN KEY (`marketer_campaign_sample_id`) REFERENCES `marketer_campaign_samples` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `marketer_campaign_samples` (
  ...
  `sample_owner` enum('platform','marketer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'platform = admin-owned non-refundable; marketer = allocated to specific marketer',
  `quantity` smallint unsigned NOT NULL,
  `status` enum('pending','dispatched','delivered','returned') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `marketer_campaigns` (
  ...
  `requested_by_marketer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'P-14: set when this campaign was marketer-originated. Kept after approval so approveMarketerRequest() knows which marketer to auto-accept.',
  `vendor_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `travel_package_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `classified_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `campaign_category` enum('product','travel','classified') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product' COMMENT 'Derived from which FK is set. product = vendor/admin listing, travel = travel_package_id, classified = classified_listing_id',
  `product_category_selection_mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all' COMMENT 'all | include | exclude — scopes which Category rows this campaign/marketer setting applies to. Specific ids live in marketer_campaign_category_rules.',
  `classified_category_selection_mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all' COMMENT 'all | include | exclude — scopes which ClassifiedCategory rows this campaign/marketer setting applies to. Specific ids live in marketer_campaign_category_rules.',
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `commission_type` enum('fixed','tiered','last_click') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'fixed: flat per sale; tiered: per order milestone; last_click: last referral wins',
  `max_commission_budget` bigint NOT NULL DEFAULT '0' COMMENT 'Max total commission vendor will pay. BIGINT base-currency. No /100.',
  `commission_budget_spent` bigint NOT NULL DEFAULT '0' COMMENT 'Base-currency integer sum of commission_amount + flash_sale_bonus_amount for this campaign''s non-reversed conversions.',
  ...
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` enum('pending_admin','marketer_requested','active','auto_approved','rejected','paused','done','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_admin',
  ...
  KEY `marketer_campaigns_owner_type_owner_id_index` (`owner_type`,`owner_id`),
...
CREATE TABLE `marketer_category_commissions` (
  ...
  `commission_mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage' COMMENT 'fixed | percentage | both. When fixed/both, commission_flat_amount applies.',
  `commission_rate` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT 'Percentage, e.g. 8.00 = 8%.',
  `commission_flat_amount` bigint unsigned DEFAULT NULL COMMENT 'Flat commission amount (base currency unit), used when commission_mode is fixed or both.',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_commission_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_commission_rules` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rule_key` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null = platform default for the scope.',
  `scope` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'products | open_market | travel',
  `category_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null = default for the whole scope.',
  `excluded_category_ids` json DEFAULT NULL COMMENT 'Only for scope-default rules (category_id null): categories this rule does not apply to.',
  `commission_mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage',
  `commission_rate` decimal(5,2) NOT NULL DEFAULT '0.00',
  `commission_flat_amount` bigint unsigned DEFAULT NULL,
  `updated_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `mcr_scope_category_idx` (`scope`,`category_type`,`category_id`),
  KEY `marketer_commission_rules_marketer_id_index` (`marketer_id`),
  KEY `marketer_commission_rules_updated_by_admin_id_foreign` (`updated_by_admin_id`),
  CONSTRAINT `marketer_commission_rules_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_commission_rules_updated_by_admin_id_foreign` FOREIGN KEY (`updated_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_contract_acceptances`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_contract_acceptances` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_contract_version_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `mca_customer_version_index` (`customer_id`,`marketer_contract_version_id`),
  KEY `marketer_contract_acceptances_order_id_index` (`order_id`),
  KEY `mca_version_foreign` (`marketer_contract_version_id`),
  KEY `mca_marketer_version_index` (`marketer_id`,`marketer_contract_version_id`),
  KEY `mca_customer_version_order_index` (`customer_id`,`marketer_contract_version_id`,`order_id`),
  CONSTRAINT `marketer_contract_acceptances_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `marketer_contract_acceptances_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_contract_acceptances_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE SET NULL,
  CONSTRAINT `mca_version_foreign` FOREIGN KEY (`marketer_contract_version_id`) REFERENCES `marketer_contract_versions` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_contract_versions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_contract_versions` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_contract_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `version_number` int unsigned NOT NULL,
  `content_type` enum('pdf','text') COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Storage path for PDF contracts',
  `text_content` longtext COLLATE utf8mb4_unicode_ci COMMENT 'For text/HTML contracts',
  `title_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_ar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `uploaded_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `mcv_contract_version_unique` (`marketer_contract_id`,`version_number`),
  KEY `mcv_contract_active_index` (`marketer_contract_id`,`is_active`),
  KEY `marketer_contract_versions_uploaded_by_admin_id_foreign` (`uploaded_by_admin_id`),
  CONSTRAINT `marketer_contract_versions_marketer_contract_id_foreign` FOREIGN KEY (`marketer_contract_id`) REFERENCES `marketer_contracts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_contract_versions_uploaded_by_admin_id_foreign` FOREIGN KEY (`uploaded_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_contracts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_contracts` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_version` int unsigned NOT NULL DEFAULT '0',
  `is_required` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'If true, customer must accept before proceeding',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `marketer_contracts_marketer_id_unique` (`marketer_id`),
  CONSTRAINT `marketer_contracts_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_conversation_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_conversation_messages` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `conversation_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sender_type` enum('marketer','customer') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `marketer_conversation_messages_conversation_id_created_at_index` (`conversation_id`,`created_at`),
  CONSTRAINT `marketer_conversation_messages_conversation_id_foreign` FOREIGN KEY (`conversation_id`) REFERENCES `marketer_conversations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_conversations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_conversations` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `classified_listing_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `classified_inquiry_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_message_at` timestamp NULL DEFAULT NULL,
  `marketer_has_unread` tinyint(1) NOT NULL DEFAULT '0',
  `customer_has_unread` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `mc_unique_ctx` (`marketer_id`,`customer_id`,`classified_listing_id`),
  KEY `marketer_conversations_classified_listing_id_foreign` (`classified_listing_id`),
  KEY `marketer_conversations_marketer_id_last_message_at_index` (`marketer_id`,`last_message_at`),
  KEY `marketer_conversations_customer_id_last_message_at_index` (`customer_id`,`last_message_at`),
  CONSTRAINT `marketer_conversations_classified_listing_id_foreign` FOREIGN KEY (`classified_listing_id`) REFERENCES `classified_listings` (`id`) ON DELETE SET NULL,
  CONSTRAINT `marketer_conversations_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_conversations_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_documents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_documents` (
  ...
  `disk` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'private',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `marketer_documents_marketer_id_type_index` (`marketer_id`,`type`),
  CONSTRAINT `marketer_documents_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_job_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_job_categories` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_job_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `marketer_job_categories_job_type_category_unique` (`marketer_job_id`,`category_type`,`category_id`),
  KEY `marketer_job_categories_marketer_job_id_index` (`marketer_job_id`),
  KEY `marketer_job_categories_category_id_index` (`category_id`),
  CONSTRAINT `marketer_job_categories_marketer_job_id_foreign` FOREIGN KEY (`marketer_job_id`) REFERENCES `marketer_jobs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_jobs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_jobs` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `marketer_jobs_key_unique` (`key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `marketer_listings` (
  ...
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `invitation_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_type` enum('vendor_listing','admin_listing') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_listing_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `travel_package_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `classified_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `listing_category` enum('product','travel','classified') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product',
  ...
  `paused_reason` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'manual = marketer paused it themselves; source_unavailable = auto-paused by the availability sync (P-15)',
  `condition` enum('new','like_new','good','acceptable','refurbished') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  `score` decimal(8,4) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_marketer_job` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_job_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `marketer_marketer_job_marketer_id_marketer_job_id_unique` (`marketer_id`,`marketer_job_id`),
  KEY `marketer_marketer_job_marketer_job_id_foreign` (`marketer_job_id`),
  CONSTRAINT `marketer_marketer_job_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `marketer_marketer_job_marketer_job_id_foreign` FOREIGN KEY (`marketer_job_id`) REFERENCES `marketer_jobs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketer_marketer_job_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketer_marketer_job_category` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_marketer_job_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `mmjc_unique` (`marketer_marketer_job_id`,`category_type`,`category_id`),
  KEY `marketer_marketer_job_category_category_id_index` (`category_id`),
  CONSTRAINT `marketer_marketer_job_category_marketer_marketer_job_id_foreign` FOREIGN KEY (`marketer_marketer_job_id`) REFERENCES `marketer_marketer_job` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `marketer_profiles` (
  ...
  `video_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'YouTube/Instagram reel URL',
  ...
  `qr_code_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `profile_slug` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `broker_serves_all_cities` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'If true, broker_city_id is ignored and broker serves all cities',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `specialty_en` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `specialty_ar` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `marketer_profiles_broker_category_id_foreign` (`broker_category_id`),
  KEY `marketer_profiles_broker_city_id_foreign` (`broker_city_id`),
  KEY `marketer_profiles_avatar_file_id_foreign` (`avatar_file_id`),
  CONSTRAINT `marketer_profiles_avatar_file_id_foreign` FOREIGN KEY (`avatar_file_id`) REFERENCES `files` (`id`) ON DELETE SET NULL,
  CONSTRAINT `marketer_profiles_banner_file_id_foreign` FOREIGN KEY (`banner_file_id`) REFERENCES `files` (`id`) ON DELETE SET NULL,
  CONSTRAINT `marketer_profiles_broker_category_id_foreign` FOREIGN KEY (`broker_category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL,
  CONSTRAINT `marketer_profiles_broker_city_id_foreign` FOREIGN KEY (`broker_city_id`) REFERENCES `cities` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `marketers` (
  ...
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_verified_at` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'timestamp when phone was verified',
  `whatsapp_for_campaigns` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'WhatsApp number for campaign invitation messages',
  `global_status` enum('pending','active','inactive','suspended','rejected','blacklisted','under_review') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `marketplace_shipping_rules` (
  ...
  `max_dimensions_cm` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'LxWxH e.g. 200x100x80',
  `special_handling_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `commission_type` enum('fixed','percentage','mixed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage',
...
CREATE TABLE `newsletter_subscribers` (
  ...
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'website',
  `locale` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ar',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `unsubscribe_token` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `open_market_category_commissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `open_market_category_commissions` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null = default rate for this classified category, applied to all marketers.',
  `classified_category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Null = default rate applied across all classified categories for this marketer.',
  `commission_mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage' COMMENT 'fixed | percentage | both.',
  `commission_rate` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT 'Percentage, e.g. 8.00 = 8%.',
  `commission_flat_amount` bigint unsigned DEFAULT NULL COMMENT 'Flat commission amount (base currency unit), used when commission_mode is fixed or both.',
  `updated_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `omcc_marketer_category_unique` (`marketer_id`,`classified_category_id`),
  KEY `open_market_category_commissions_classified_category_id_foreign` (`classified_category_id`),
  KEY `open_market_category_commissions_updated_by_admin_id_foreign` (`updated_by_admin_id`),
  CONSTRAINT `open_market_category_commissions_classified_category_id_foreign` FOREIGN KEY (`classified_category_id`) REFERENCES `classified_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `open_market_category_commissions_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `open_market_category_commissions_updated_by_admin_id_foreign` FOREIGN KEY (`updated_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `open_market_listing_prices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `open_market_listing_prices` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `classified_category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The open-market (classified) category this base price applies to.',
  `base_price` bigint unsigned NOT NULL COMMENT 'Base listing price (base currency unit) for this classified category.',
  `allow_marketer_override` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'When true, the marketer may set their own price for listings in this category, bounded by min_price/max_price if set.',
  `min_price` bigint unsigned DEFAULT NULL COMMENT 'Lower bound for a marketer-overridden price, when allow_marketer_override is true.',
  `max_price` bigint unsigned DEFAULT NULL COMMENT 'Upper bound for a marketer-overridden price, when allow_marketer_override is true.',
  `updated_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `omlp_classified_category_unique` (`classified_category_id`),
  KEY `open_market_listing_prices_updated_by_admin_id_foreign` (`updated_by_admin_id`),
  CONSTRAINT `open_market_listing_prices_classified_category_id_foreign` FOREIGN KEY (`classified_category_id`) REFERENCES `classified_categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `open_market_listing_prices_updated_by_admin_id_foreign` FOREIGN KEY (`updated_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_item_allocations` (
  ...
  `quantity` int NOT NULL,
  `status` enum('reserved','committed','released','returned') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'reserved',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_item_allocations_order_item_id_status_index` (`order_item_id`,`status`),
  KEY `order_item_allocations_warehouse_inventory_id_status_index` (`warehouse_inventory_id`,`status`),
  CONSTRAINT `order_item_allocations_order_item_id_foreign` FOREIGN KEY (`order_item_id`) REFERENCES `order_items` (`id`) ON DELETE CASCADE,
  CONSTRAINT `order_item_allocations_warehouse_inventory_id_foreign` FOREIGN KEY (`warehouse_inventory_id`) REFERENCES `warehouse_inventories` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `order_item_custom_attribute_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_item_custom_attribute_values` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_item_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_custom_attribute_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `label` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `oicav_product_custom_attribute_id_fk` (`product_custom_attribute_id`),
  KEY `order_item_custom_attribute_values_order_item_id_index` (`order_item_id`),
  CONSTRAINT `oicav_product_custom_attribute_id_fk` FOREIGN KEY (`product_custom_attribute_id`) REFERENCES `product_custom_attributes` (`id`) ON DELETE SET NULL,
  CONSTRAINT `order_item_custom_attribute_values_order_item_id_foreign` FOREIGN KEY (`order_item_id`) REFERENCES `order_items` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_items` (
  ...
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketer_listing_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketer_campaign_invitation_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_snapshot` json NOT NULL,
  `vendor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sku` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity` int NOT NULL,
  `unit_price` decimal(19,4) NOT NULL,
  `unit_cost_price` decimal(19,4) DEFAULT NULL,
  `line_subtotal` decimal(19,4) NOT NULL,
  `line_discount` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `vendor_coupon_cost` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `line_tax` decimal(19,4) NOT NULL,
  `line_total` decimal(19,4) NOT NULL,
  `commission_rate_pct` decimal(5,2) NOT NULL,
  `commission_fixed` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `commission_category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'The category from which commission rates were resolved (may be an ancestor if inherited)',
  `commission_amount` decimal(19,4) NOT NULL,
  `marketer_commission` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `platform_commission_after_discount` decimal(19,4) NOT NULL DEFAULT '0.0000',
  ...
  `shipping_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `warranty_purchase_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `order_items_marketer_listing_id_index` (`marketer_listing_id`),
  KEY `order_items_marketer_campaign_invitation_id_foreign` (`marketer_campaign_invitation_id`),
  KEY `order_items_sub_order_fulfillment_status_index` (`sub_order_id`,`fulfillment_status`),
  ...
  CONSTRAINT `order_items_marketer_campaign_invitation_id_foreign` FOREIGN KEY (`marketer_campaign_invitation_id`) REFERENCES `marketer_campaign_invitations` (`id`) ON DELETE SET NULL,
  CONSTRAINT `order_items_marketer_listing_id_foreign` FOREIGN KEY (`marketer_listing_id`) REFERENCES `marketer_listings` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `orders` (
  ...
  `loyalty_discount` decimal(19,4) NOT NULL DEFAULT '0.0000',
  ...
  `warranty_total` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `total` decimal(19,4) NOT NULL,
  `wallet_amount_used` decimal(19,4) unsigned NOT NULL DEFAULT '0.0000',
  `coupon_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_gateway_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketer_contract_acceptance_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `delivery_instruction` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip_address` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_agent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  KEY `orders_marketer_contract_acceptance_id_foreign` (`marketer_contract_acceptance_id`),
  CONSTRAINT `orders_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `orders_marketer_contract_acceptance_id_foreign` FOREIGN KEY (`marketer_contract_acceptance_id`) REFERENCES `marketer_contract_acceptances` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `packaging_supplies` (
  ...
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_ar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type` enum('box','bag','tape','label','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `packaging_supply_countries` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `packaging_supply_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_cost` bigint unsigned NOT NULL DEFAULT '0',
  `stock_available` int DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `packaging_supply_requests` (
  ...
  `vendor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `warehouse_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('pending','approved','shipped','delivered','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `shipped_at` timestamp NULL DEFAULT NULL,
  `delivered_at` timestamp NULL DEFAULT NULL,
  `fee_deducted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `page_blocks` (
  ...
  `app_context_key` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Restricts block to an app context (e.g. nawy_now). NULL = shown in every context.',
  `position` int NOT NULL DEFAULT '0',
  ...
  KEY `page_blocks_page_section_visible_position_index` (`page_id`,`section_id`,`is_visible`,`position`),
...
CREATE TABLE `page_sections` (
  ...
  `background_image_url_en` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `background_image_url_ar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `background_image_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'section' COMMENT 'section = covers whole section, header = covers title area only',
  ...
  `layout` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stack',
  `columns_config` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `pages` (
  ...
  `app_context_key` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Links page to an app context (main, nawy_now, classifieds, travel). NULL = general/admin use.',
  `reference_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
...
CREATE TABLE `paid_ad_bookings` (
  ...
  `advertiser_type` enum('vendor','marketer') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'vendor',
  `vendor_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `budget_amount` bigint DEFAULT NULL COMMENT 'CPM/CPC spend cap',
  ...
  `payment_method` enum('wallet','payout_deduction','offline') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_transaction_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `offline_proof_file_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `offline_proof_uploaded_at` timestamp NULL DEFAULT NULL,
  ...
  `subscription_charged` bigint unsigned NOT NULL DEFAULT '0',
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  ...
  `cancelled_at` timestamp NULL DEFAULT NULL,
  `cancelled_by` enum('vendor','marketer','admin','system') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cancellation_reason` text COLLATE utf8mb4_unicode_ci,
  `created_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Set when admin books on behalf of an advertiser',
  PRIMARY KEY (`id`),
  UNIQUE KEY `paid_ad_bookings_booking_reference_unique` (`booking_reference`),
  KEY `paid_ad_bookings_vendor_id_foreign` (`vendor_id`),
  KEY `paid_ad_bookings_country_id_foreign` (`country_id`),
  KEY `paid_ad_bookings_marketer_id_foreign` (`marketer_id`),
  KEY `pab_slot_status_dates_idx` (`paid_ad_slot_id`,`status`,`booked_from`,`booked_until`),
  KEY `paid_ad_bookings_advertiser_type_vendor_id_status_index` (`advertiser_type`,`vendor_id`,`status`),
  KEY `paid_ad_bookings_advertiser_type_marketer_id_status_index` (`advertiser_type`,`marketer_id`,`status`),
  KEY `paid_ad_bookings_status_payment_due_at_index` (`status`,`payment_due_at`),
  CONSTRAINT `paid_ad_bookings_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_bookings_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_bookings_paid_ad_slot_id_foreign` FOREIGN KEY (`paid_ad_slot_id`) REFERENCES `paid_ad_slots` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_bookings_vendor_id_foreign` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `paid_ad_charges`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paid_ad_charges` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `paid_ad_booking_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `advertiser_type` enum('vendor','marketer') COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('fixed','cpm','cpc','budget_reserve','refund','adjustment') COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` bigint NOT NULL COMMENT 'Positive = charge to advertiser, negative = refund. Base currency.',
  `tax_amount` bigint NOT NULL DEFAULT '0',
  `settlement` enum('wallet','payout_deduction','offline') COLLATE utf8mb4_unicode_ci NOT NULL,
  `wallet_transaction_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payout_id` bigint unsigned DEFAULT NULL COMMENT 'payouts.id is bigint',
  `settled_at` timestamp NULL DEFAULT NULL,
  `note` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by_admin_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `paid_ad_charges_payout_id_foreign` (`payout_id`),
  KEY `pac_vendor_settle_idx` (`vendor_id`,`settlement`,`payout_id`,`currency`),
  KEY `paid_ad_charges_paid_ad_booking_id_type_index` (`paid_ad_booking_id`,`type`),
  CONSTRAINT `paid_ad_charges_paid_ad_booking_id_foreign` FOREIGN KEY (`paid_ad_booking_id`) REFERENCES `paid_ad_bookings` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_charges_payout_id_foreign` FOREIGN KEY (`payout_id`) REFERENCES `payouts` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paid_ad_creatives` (
  ...
  `destination_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `destination_reference_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referral_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Snapshot for destination_type=campaign (marketer referral)',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `rejection_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `paid_ad_creatives_marketer_id_foreign` (`marketer_id`),
  KEY `paid_ad_creatives_paid_ad_booking_id_is_current_status_index` (`paid_ad_booking_id`,`is_current`,`status`),
  CONSTRAINT `paid_ad_creatives_marketer_id_foreign` FOREIGN KEY (`marketer_id`) REFERENCES `marketers` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_creatives_paid_ad_booking_id_foreign` FOREIGN KEY (`paid_ad_booking_id`) REFERENCES `paid_ad_bookings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `paid_ad_daily_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paid_ad_daily_stats` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `paid_ad_booking_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `paid_ad_daily_stats_paid_ad_booking_id_date_unique` (`paid_ad_booking_id`,`date`),
  CONSTRAINT `paid_ad_daily_stats_paid_ad_booking_id_foreign` FOREIGN KEY (`paid_ad_booking_id`) REFERENCES `paid_ad_bookings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paid_ad_slots` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_type` enum('placement','page_block','listing_promotion') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'placement',
  `shows_popup` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'false = listing_promotion tier 1 (boost only). true  = listing_promotion tier 2 (boost + storefront popup).',
  `placement_definition_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_block_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_position` smallint unsigned DEFAULT NULL COMMENT '1-based visual index inside the block. NULL = whole block (full_banner).',
  `bound_item_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'DB id of the SliderSlide or AdImageItem this slot is bound to. Used to remap item_position after reorders.',
  `fill_mode` enum('replace','insert') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'replace',
  `country_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Optional scope for category_top / product_page_bottom placements.',
  `name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `pricing_model` enum('fixed_daily','fixed_weekly','fixed_monthly','cpm','cpc') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `notes_for_vendors_ar` text COLLATE utf8mb4_unicode_ci,
  `created_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `creative_width_px` int unsigned DEFAULT NULL,
  `creative_height_px` int unsigned DEFAULT NULL,
  `mobile_width_px` int unsigned DEFAULT NULL,
  `mobile_height_px` int unsigned DEFAULT NULL,
  `max_concurrent` int unsigned NOT NULL DEFAULT '1' COMMENT 'Bookings that may run on the same day (rotation).',
  `lead_time_days` smallint unsigned NOT NULL DEFAULT '1' COMMENT 'Minimum days between booking submit and booked_from.',
  `min_budget` bigint DEFAULT NULL COMMENT 'CPM/CPC minimum budget, base currency.',
  `allowed_advertisers` enum('vendor','marketer','both') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'vendor',
  `sort_order` int NOT NULL DEFAULT '0',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `paid_ad_slots_category_id_foreign` (`category_id`),
  KEY `paid_ad_slots_target_type_country_id_is_available_index` (`target_type`,`country_id`,`is_available`),
  KEY `paid_ad_slots_page_block_id_item_position_index` (`page_block_id`,`item_position`),
  KEY `paid_ad_slots_bound_item_id_index` (`bound_item_id`),
  CONSTRAINT `paid_ad_slots_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL,
  CONSTRAINT `paid_ad_slots_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_slots_page_block_id_foreign` FOREIGN KEY (`page_block_id`) REFERENCES `page_blocks` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `paid_ad_slots_placement_definition_id_foreign` FOREIGN KEY (`placement_definition_id`) REFERENCES `banner_placement_definitions` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_gateway_webhook_logs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_payment_gateway_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `payment_gateways` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('redirect','direct','offline','internal') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `payment_transactions` (
  ...
  `amount` bigint NOT NULL,
  `gateway_amount` bigint DEFAULT NULL,
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gateway_currency` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `payout_items` (
  ...
  `sub_order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_conversion_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_type` enum('sub_order','marketer_commission') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sub_order',
...
CREATE TABLE `platform_shipping_subsidies` (
  ...
  `shipping_zone_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `subsidy_cap` bigint NOT NULL DEFAULT '0' COMMENT 'Max amount platform covers per delivery, base currency units',
  `split_type` enum('percentage','fixed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage' COMMENT 'percentage = vendor_share_pct + admin covers rest; fixed = fixed amounts',
...
CREATE TABLE `portal_contents` (
  ...
  `block_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `field_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('text','richtext','link','image') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
  ...
  `value_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `updated_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `product_bestseller_rankings` (
  ...
  `period` enum('daily','weekly','monthly') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'monthly',
  `calculated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `product_cost_references` (
  ...
  `manufacturer_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manufacturer_sku` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `product_country_buybox`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_country_buybox` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `listing_type` enum('admin','vendor','marketer') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `admin_listing_count` int unsigned NOT NULL DEFAULT '0',
  `total_stock` int unsigned NOT NULL DEFAULT '0',
  `rating_avg` decimal(3,2) NOT NULL DEFAULT '0.00',
  `rating_count` int unsigned NOT NULL DEFAULT '0',
  `fulfillment_model` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `product_country_buybox_country_id_category_id_score_index` (`country_id`,`category_id`,`score`),
  KEY `product_country_buybox_country_id_category_id_price_index` (`country_id`,`category_id`,`price`),
  KEY `product_country_buybox_country_id_brand_id_index` (`country_id`,`brand_id`),
  KEY `product_country_buybox_country_id_total_sold_index` (`country_id`,`total_sold`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_custom_attributes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_custom_attributes_product_id_sort_order_index` (`product_id`,`sort_order`),
  CONSTRAINT `product_custom_attributes_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_highlights` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `text_en` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `text_ar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `product_images` (
  ...
  KEY `product_images_variant_primary_position_index` (`product_variant_id`,`is_primary`,`position`),
...
CREATE TABLE `product_price_history` (
  ...
  `price` bigint NOT NULL,
  `recorded_at` timestamp NOT NULL,
  `source` enum('initial','update') COLLATE utf8mb4_unicode_ci NOT NULL,
  `recorded_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_price_history_vendor_listing_id_recorded_at_index` (`vendor_listing_id`,`recorded_at`),
  CONSTRAINT `product_price_history_vendor_listing_id_foreign` FOREIGN KEY (`vendor_listing_id`) REFERENCES `vendor_listings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `product_promo_badges`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_promo_badges` (
  ...
  `color_hex` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#1a1a2e',
  `text_color_hex` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#FFFFFF',
  `sort_order` smallint unsigned NOT NULL DEFAULT '0',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `product_specifications` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `key_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `key_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_en` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_ar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `position` smallint unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `product_variants` (
  ...
  `variant_name_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `size_guide_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  FULLTEXT KEY `products_fulltext_search` (`name_en`,`name_ar`,`short_desc_en`,`short_desc_ar`) /*!50100 WITH PARSER `ngram` */ 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `radio_channels` (
  ...
  `name_en` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_ar` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('audio','video') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `stream_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fallback_media_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `radio_listen_sessions` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `radio_channel_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `session_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `started_at` timestamp NOT NULL,
  `ended_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `radio_schedule_slots` (
  ...
  `starts_at` timestamp NOT NULL,
  `ends_at` timestamp NOT NULL,
  `recurrence` enum('once','daily','weekly') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'once',
...
CREATE TABLE `refunds` (
  ...
  `order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sub_order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `original_transaction_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `initiated_by_customer_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `initiated_by_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `initiated_by_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `return_request_message_attachments` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `return_request_message_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `reviews` (
  ...
  `vendor_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_product_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_item_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `translated_body` text COLLATE utf8mb4_unicode_ci,
  `original_language` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `roles` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `guard_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `travel_agency_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `search_suggestions` (
  ...
  `keyword_normalized` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `shipping_companies` (
  ...
  `status` enum('pending','active','suspended') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  KEY `shipping_companies_owner_vendor_id_index` (`owner_vendor_id`),
...
CREATE TABLE `shipping_company_supervisors` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_company_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `shipping_fallback_rules` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `unserved_city_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `fallback_shipping_company_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `shipping_methods` (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `badge_label_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Short label shown on listing card badge, e.g. "express", "supermall"',
  `badge_label_ar` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `badge_color_hex` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#1a1a2e' COMMENT 'Background color for the badge pill on listing cards',
  `badge_text_color_hex` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#FFFFFF',
  `badge_icon_color_hex` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `badge_image_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `badge_show_delivery_time` tinyint(1) NOT NULL DEFAULT '0',
  `badge_delivery_text_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `badge_delivery_text_ar` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `badge_icon` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT 'bolt',
  PRIMARY KEY (`id`),
...
CREATE TABLE `slugs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sluggable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sluggable_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `storage_fee_free_period_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `storage_fee_free_period_rules` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `min_weight_grams` int unsigned NOT NULL,
  `max_weight_grams` int unsigned DEFAULT NULL,
  `free_days` smallint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sub_orders` (
  ...
  `subtotal` decimal(19,4) NOT NULL,
  `shipping` decimal(19,4) NOT NULL,
  `carrier_shipping_cost` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `shipping_gap` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `exceptional_zone_subsidy_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_subsidy_amount` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `vendor_contribution_amount` decimal(19,4) NOT NULL DEFAULT '0.0000',
  ...
  `vendor_coupon_cost` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `platform_coupon_cost` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `marketer_commission` decimal(19,4) NOT NULL DEFAULT '0.0000',
  `marketer_commission_owner` enum('vendor','platform') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Who pays marketer_commission for this sub-order: the vendor (vendor-listing campaign) or the platform (admin-listing campaign).',
  `warranty_revenue` decimal(19,4) NOT NULL DEFAULT '0.0000',
  ...
  `vendor_payout` decimal(19,4) NOT NULL,
  ...
  `cod_settlement_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'The settlement that confirmed cash receipt for this sub_order.',
  `shipping_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `carrier_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracking_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_plans` (
  ...
  `price` bigint NOT NULL,
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `billing_cycle` enum('monthly','quarterly','annual') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'monthly',
...
CREATE TABLE `support_tickets` (
  ...
  `requester_role` enum('customer','seller','delivery_agent','shipping_supervisor','travel_agency','marketer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `related_assignment_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `travel_agency_campaign_invitations` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `travel_agency_campaign_offer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `marketer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('pending','accepted','declined','expired','revoked') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `marketer_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Optional note from marketer when accepting or declining',
  `vendor_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Private note from the travel agency visible only to the agency and admin — column name mirrors vendor_campaign_invitations for schema parity',
  `responded_at` timestamp NULL DEFAULT NULL,
  ...
  `resulting_campaign_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'The marketer_campaigns row auto-created when this invitation is accepted',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `travel_agency_campaign_offers` (
  ...
  `travel_agency_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Brief for the marketer — what the campaign is about, what content they should create, any brand guidelines',
  `requirements` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'What the agency expects: post format, minimum posts, hashtags, disclosure requirements — shown to invited marketers',
  `campaign_type` enum('product_promotion','store_promotion','brand_deal','product_specific','flash_sale') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product_promotion' COMMENT 'Travel-agency-originated offers reuse the shared CampaignType value set — no classified_promotion here',
  ...
  `commission_type` enum('percentage','flat_per_order','flat_per_click') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percentage' COMMENT 'flat_per_order is interpreted as flat-per-confirmed-booking for travel campaigns',
  ...
  `status` enum('draft','pending_admin','active','paused','ended','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  `rejected_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `attribution_model` enum('last_click','first_click','linear') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'last_click',
...
CREATE TABLE `travel_agency_change_requests` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `travel_agency_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requested_by_travel_agency_member_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `section` enum('bank_accounts') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_type` enum('add','edit','delete') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'edit',
  `current_data` json NOT NULL,
  `requested_data` json NOT NULL,
  `agency_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `travel_agency_section_locks` (
  ...
  `locked_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `locked_at` timestamp NOT NULL,
  `unlocked_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `travel_bookings` (
  ...
  `total_price` bigint unsigned NOT NULL,
  `passport_file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contract_signed_at` timestamp NULL DEFAULT NULL,
  `contract_signature_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` enum('pending_documents','confirmed','cancelled','completed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_documents',
  `cancellation_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `travel_cities` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `travel_country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_ar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `latitude` decimal(10,7) DEFAULT NULL,
  `longitude` decimal(10,7) DEFAULT NULL,
...
CREATE TABLE `travel_package_categories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `travel_package_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `travel_category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `travel_package_inclusions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `travel_package_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `travel_inclusion_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `travel_package_inquiries` (
  ...
  `converted_to_booking_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `travel_packages` (
  ...
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_ar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `destination_country` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination_city` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination_travel_country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination_travel_city_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price` bigint unsigned NOT NULL,
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` enum('draft','pending_review','active','sold_out','expired') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contract_file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contract_file_original_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `vendor_acquisition_commission_earnings` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `commission_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sub_order_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `month` date NOT NULL,
...
CREATE TABLE `vendor_acquisition_commissions` (
  ...
  `status` enum('active','expired','revoked') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
...
CREATE TABLE `vendor_change_requests` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requested_by_vendor_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `section` enum('store_profile','business_info','contact_info','documents','bank_accounts') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_type` enum('edit','add','delete') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'edit',
  ...
  `vendor_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` enum('pending','approved','rejected','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `reviewed_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `admin_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `vendor_document_country_requirements` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_document_type_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `requirement_level` enum('mandatory','optional','not_applicable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'optional',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `vendor_exceptional_zone_alert_results` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `alert_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_zone_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_method_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_subsidy_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_exceptional_zone_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `vendor_exceptional_zone_alerts` (
  ...
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Currency of the reported carrier fee',
  `vendor_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `vendor_listings` (
  ...
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` bigint NOT NULL,
  `first_price` bigint DEFAULT NULL,
  `first_price_locked_at` timestamp NULL DEFAULT NULL,
  `disposable_by_admin` tinyint(1) NOT NULL DEFAULT '0',
  `compare_at_price` bigint DEFAULT NULL,
  ...
  `fbm_payment_gateway_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'For FBM vendors: which gateway customer pays through. Null = platform default.',
  ...
  `weight_class` enum('light','medium','heavy') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Display/filter helper only, not authoritative: light <= 1000g, medium 1001-5000g, heavy > 5000g',
  `handling_class` enum('standard','refrigerated','fragile','special_tech') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'standard',
  ...
  KEY `vendor_listings_fbm_payment_gateway_id_foreign` (`fbm_payment_gateway_id`),
  CONSTRAINT `vendor_listings_fbm_payment_gateway_id_foreign` FOREIGN KEY (`fbm_payment_gateway_id`) REFERENCES `payment_gateways` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `vendor_payment_methods` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `vendor_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_gateway_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_enabled` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `vendor_payment_methods_vendor_id_payment_gateway_id_unique` (`vendor_id`,`payment_gateway_id`),
  KEY `vendor_payment_methods_payment_gateway_id_foreign` (`payment_gateway_id`),
  CONSTRAINT `vendor_payment_methods_payment_gateway_id_foreign` FOREIGN KEY (`payment_gateway_id`) REFERENCES `payment_gateways` (`id`) ON DELETE CASCADE,
  CONSTRAINT `vendor_payment_methods_vendor_id_foreign` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vendor_product_certifications` (
  ...
  `original_filename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Original uploaded filename, stored for display',
  `cert_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Optional: vendor-provided label e.g. "SFDA Certificate #12345"',
...
CREATE TABLE `vendor_section_locks` (
  ...
  `section` enum('store_profile','business_info','contact_info','documents','bank_accounts') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_locked` tinyint(1) NOT NULL DEFAULT '1',
  `locked_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Shown to vendor, e.g. "Under review"',
  `locked_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `locked_at` timestamp NOT NULL,
  `unlocked_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unlocked_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `vendor_subscriptions` (
  ...
  `status` enum('active','cancelled','expired','past_due','trialing') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `started_at` timestamp NOT NULL,
...
CREATE TABLE `vendors` (
  ...
  `store_description_ar` text COLLATE utf8mb4_unicode_ci,
  `specialization_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `specialization_ar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_as_described_pct` tinyint unsigned DEFAULT NULL,
  ...
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `global_status` enum('pending','active','inactive','suspended','rejected','blacklisted','under_review') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `vendor_type` enum('product_vendor','classified_vendor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'product_vendor' COMMENT 'Mutually exclusive account type: sells products via vendor_listings, or classified ads via classified_listings.',
  `last_login_at` timestamp NULL DEFAULT NULL,
  `last_login_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `onboarding_completed_at` timestamp NULL DEFAULT NULL,
  `account_manager_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `virtual_tryon_sessions` (
  ...
  `vendor_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_photo_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `result_image_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('queued','processing','completed','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued',
  `provider` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Which AI service was used',
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `voucher_redemptions` (
  ...
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_wallet_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `voucher_redemptions_wallet_id_index` (`wallet_id`),
  ...
  CONSTRAINT `voucher_redemptions_wallet_id_foreign` FOREIGN KEY (`wallet_id`) REFERENCES `wallets` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vouchers` (
  ...
  `currency_code` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_eligibility` enum('all','new_customers','specific_users') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
  `eligible_customer_ids` json DEFAULT NULL COMMENT 'JSON array of customer UUIDs. Used when customer_eligibility = specific_users.',
...
CREATE TABLE `wallet_transactions` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `wallet_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `direction` enum('credit','debit') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` bigint NOT NULL,
  `balance_after` bigint NOT NULL,
  `currency_code` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `wallet_withdrawal_requests` (
  ...
  `status` enum('pending','approved','processed','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `approved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processed_at` timestamp NULL DEFAULT NULL,
  `rejection_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `wallets` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_type` enum('customer','vendor','marketer','delivery_agent','travel_agency') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `owner_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `balance` bigint NOT NULL DEFAULT '0',
  `pending_balance` bigint NOT NULL DEFAULT '0',
  `currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_frozen` tinyint(1) NOT NULL DEFAULT '0',
  `frozen_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `warehouse_exceptional_zones` (
  ...
  `carrier_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `source_alert_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `warehouse_inventories` (
  ...
  `first_stocked_at` timestamp NULL DEFAULT NULL COMMENT 'Timestamp when inventory was first received — used for free storage period calculation',
...
CREATE TABLE `warehouse_vendor_limits` (
  ...
  `warehouse_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `limit_type` enum('quantity','capacity') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `warehouses` (
  ...
  `default_limit_type` enum('quantity','capacity') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `daily_fee_currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `storage_rate_per_m3_price` bigint DEFAULT NULL,
  `storage_currency` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `warranty_claim_messages` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `warranty_claim_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sender_user_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sender_role` enum('customer','vendor','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_internal_note` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `warranty_claims` (
  ...
  `product_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `listing_type` enum('vendor_listing','admin_listing','marketer_listing') COLLATE utf8mb4_unicode_ci NOT NULL,
  `claim_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'brand',
  `issue_type` enum('defective','not_working','physical_damage','missing_parts','software_issue','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `evidence_files` json DEFAULT NULL,
  `status` enum('submitted','under_review','approved','rejected','resolved') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'submitted',
  `resolution` enum('repair','replace','refund','no_action') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `resolution_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `resolved_by_admin_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `warranty_claims_warranty_purchase_id_index` (`warranty_purchase_id`),
  CONSTRAINT `warranty_claims_warranty_purchase_id_foreign` FOREIGN KEY (`warranty_purchase_id`) REFERENCES `warranty_purchases` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `warranty_plans` (
  ...
  `price` bigint NOT NULL,
  `price_type` enum('flat','percentage') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'flat',
...
CREATE TABLE `wishlist_items` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `wishlist_group_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendor_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `classified_listing_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  UNIQUE KEY `uq_wg_marketer_listing` (`wishlist_group_id`,`marketer_listing_id`),
  ...
  KEY `wishlist_items_marketer_listing_id_index` (`marketer_listing_id`),
  ...
  CONSTRAINT `wishlist_items_marketer_listing_id_foreign` FOREIGN KEY (`marketer_listing_id`) REFERENCES `marketer_listings` (`id`) ON DELETE SET NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (462,'2026_09_09_000004_add_marketer_to_support_tickets_requester_role',51);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (463,'2026_09_09_000005_create_flash_sale_marketer_invitations_table',51);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (464,'2026_09_09_000006_add_flash_sale_fields_to_marketer_campaign_conversions',51);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (465,'2026_09_10_000001_add_variant_name_ar_to_product_variants_table',52);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (466,'2026_09_10_000002_add_is_hidden_to_products_and_variants_tables',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (481,'2026_09_11_000001_reshape_paid_ad_slots_table',54);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (482,'2026_09_11_000002_reshape_paid_ad_bookings_table',55);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (483,'2026_09_11_000003_reshape_paid_ad_creatives_table',56);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (484,'2026_09_11_000004_create_paid_ad_charges_table',57);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (502,'2026_09_12_000013_create_marketer_contracts_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (503,'2026_09_12_000014_create_marketer_contract_versions_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (504,'2026_09_12_000015_create_marketer_contract_acceptances_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (505,'2026_09_12_000016_add_contract_acceptance_to_orders_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (506,'2026_09_12_000017_add_broker_specialization_to_marketer_profiles_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (507,'2026_09_12_000018_create_customer_special_requests_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (508,'2026_09_12_000019_add_custom_inputs_settings_to_vendor_listings_table',65);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (509,'2026_09_12_000020_create_vendor_listing_custom_fields_table',65);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (520,'2026_09_12_190000_extend_paid_ad_slots_for_listing_promotion',74);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (521,'2026_09_12_190001_widen_paid_ad_creative_subtitles',74);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (522,'2026_09_13_000000_widen_paid_ad_slots_max_concurrent',75);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (523,'2026_09_13_000001_change_vendor_listings_price_columns_to_decimal',76);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (524,'2026_09_13_203538_remove_vendor_listing_custom_fields_system',77);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (525,'2026_09_13_210000_add_has_custom_attributes_to_products_table',78);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (526,'2026_09_13_210001_create_product_custom_attributes_table',78);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (527,'2026_09_13_210002_create_cart_item_custom_attribute_values_table',79);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (528,'2026_09_13_210003_create_order_item_custom_attribute_values_table',79);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (529,'2026_09_14_120000_create_marketer_campaign_sample_custom_attribute_values_table',80);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (530,'2026_09_14_174100_add_public_profile_fields_to_vendors_table',81);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (531,'2026_09_14_000000_add_authenticity_info_to_brands_table',82);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (532,'2026_09_14_212324_add_product_as_described_to_vendors_table',83);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (533,'2026_09_14_212325_add_translation_fields_to_reviews_table',83);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (534,'2026_09_14_220000_add_avatar_file_id_to_marketer_profiles_table',84);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (535,'2026_09_14_220100_add_marketer_listing_id_to_cart_items',85);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (536,'2026_09_14_220200_add_marketer_listing_id_to_wishlist_items',85);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (537,'2026_09_14_234546_add_product_page_inline_placements_to_banners',86);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (538,'2026_09_16_130309_add_show_in_footer_to_categories_table',87);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (539,'2026_09_16_130310_create_footer_links_table',88);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (540,'2026_09_15_000100_create_affiliate_promo_codes_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (541,'2026_09_17_000001_add_fk_product_images_product_variant_id',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (542,'2026_09_17_000001_add_money_split_columns_to_sub_orders_and_order_items',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (543,'2026_09_17_000002_convert_vendor_listings_prices_to_bigint',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (544,'2026_09_17_000003_add_status_to_coupon_usages_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (545,'2026_09_17_000100_add_marketer_listing_id_to_order_items',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (546,'2026_09_17_000200_make_sub_orders_and_order_items_vendor_id_nullable',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (547,'2026_09_17_000300_add_payment_gateway_fields',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (548,'2026_09_17_000400_refunds_nullable_initiator_and_polymorphic_initiator',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (549,'2026_09_17_000500_add_return_window_days_to_categories_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (550,'2026_09_17_000600_add_is_returnable_to_categories_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (551,'2026_09_17_000601_add_return_to_inventory_movements_reference_type_enum',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (552,'2026_09_17_000700_create_order_item_allocations_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (553,'2026_09_17_000701_extend_inventory_movements_for_inventory_service',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (554,'2026_09_17_000900_warranty_claims_platform_support',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (555,'2026_09_17_023001_extend_ledger_entries_account_type_enum',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (556,'2026_09_17_023002_migrate_vendors_total_sales_to_bigint',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (557,'2026_09_17_023100_add_fee_deducted_at_to_packaging_supply_requests',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (558,'2026_09_17_030100_add_marketer_campaign_invitation_id_to_order_items',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (559,'2026_09_17_030200_add_status_and_wallet_tracking_to_marketer_campaign_conversions',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (560,'2026_09_17_030300_add_commission_budget_spent_to_marketer_campaigns',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (561,'2026_09_17_040000_add_campaign_sources_to_marketer_campaigns',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (562,'2026_09_17_053001_add_source_and_paused_reason_to_marketer_listings',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (563,'2026_09_17_060000_add_marketer_to_marketer_contract_acceptances',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (564,'2026_09_17_070000_create_product_country_buybox_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (565,'2026_09_17_070100_add_fulltext_index_to_products_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (566,'2026_09_17_080000_add_p22_performance_indexes',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (567,'2026_09_17_080100_add_unique_keys_to_warehouse_inventories',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (568,'2026_09_17_090000_add_proof_fields_to_payment_transactions',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (569,'2026_09_18_000001_add_gift_cards_placements_to_banners',90);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (570,'2026_09_18_100000_backfill_wallets_from_customer_wallets',91);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (571,'2026_09_18_110000_add_wallet_id_to_voucher_redemptions',91);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (589,'2026_09_19_200000_add_subscription_charged_to_paid_ad_bookings',100);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (590,'2026_09_19_000001_add_customer_status_index_to_customer_special_requests',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (591,'2026_09_19_000001_add_order_index_to_marketer_contract_acceptances',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (592,'2026_09_19_100000_add_types_and_size_guide_to_custom_attributes',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (593,'2026_09_19_210000_add_specialty_to_marketer_profiles',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (594,'2026_09_20_100000_add_listing_types_and_all_categories_to_custom_pages',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (595,'2026_09_20_110000_repair_vendor_owned_warehouse_types',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (598,'2026_09_20_120000_add_cod_limit_columns_to_countries',102);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (599,'2026_09_20_120100_remove_cod_limit_settings',102);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (600,'2026_09_22_181832_convert_core_order_money_columns_to_decimal',103);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (601,'2026_09_22_190000_create_marketer_jobs_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (602,'2026_09_22_190100_create_marketer_job_categories_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (603,'2026_09_22_190200_create_marketer_marketer_job_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (604,'2026_09_22_190300_create_marketer_marketer_job_category_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (605,'2026_09_22_190400_migrate_marketer_type_to_marketer_jobs',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (606,'2026_09_22_190500_drop_marketer_type_from_marketers_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (607,'2026_09_22_195141_add_category_id_to_marketer_job_categories_table',105);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (608,'2026_09_22_203939_add_commission_mode_to_marketer_category_commissions_table',106);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (609,'2026_09_22_203939_create_open_market_category_commissions_table',107);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (610,'2026_09_22_210000_create_open_market_listing_prices_table',108);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (611,'2026_09_22_210100_add_category_selection_mode_to_marketer_campaigns_table',108);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (612,'2026_09_22_210200_create_marketer_campaign_category_rules_table',109);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (613,'2026_09_22_220000_create_exclusive_contracts_table',110);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (614,'2026_09_22_230000_create_coupon_vendors_table',111);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (615,'2026_09_22_230100_create_coupon_marketers_table',111);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (616,'2026_09_22_230200_create_coupon_participation_invitations_table',111);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (617,'2026_09_22_230300_create_coupon_participation_requests_table',112);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (618,'2026_09_23_000001_add_owner_vendor_id_to_shipping_companies_table',113);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (619,'2026_09_23_000002_create_vendor_payment_methods_table',113);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (620,'2026_09_23_010000_create_storage_fee_free_period_rules_table',114);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (621,'2026_09_23_020000_create_product_price_history_table',115);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (622,'2026_09_23_020001_add_first_price_snapshot_to_vendor_listings',115);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (623,'2026_09_23_030000_create_bookable_units_table',116);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (624,'2026_09_23_030001_create_bookable_unit_availability_table',116);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (625,'2026_09_23_030002_create_bookable_unit_time_slots_table',116);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (626,'2026_09_23_030003_create_bookable_unit_reservations_table',117);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (627,'2026_09_23_000001_create_marketer_commission_rules_table',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (628,'2026_09_23_000002_add_fixed_bonus_to_flash_sale_marketer_invitations',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (629,'2026_09_23_000003_add_rule_key_to_marketer_commission_rules',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (630,'2026_09_23_300005_add_payment_fields_to_coupon_participation_requests_table',119);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (631,'2026_09_23_400002_add_fbm_payment_gateway_id_to_vendor_listings',120);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (632,'2026_09_23_600002_add_volumetric_columns_to_fbn_storage_fees',121);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (633,'2026_09_23_600003_add_first_stocked_at_to_warehouse_inventories',121);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (634,'2026_09_23_700005_add_approval_and_reservation_number_to_bookable_units',122);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (635,'2026_09_23_800001_create_flight_bookings_table',123);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (636,'2026_09_24_110001_create_classified_wanted_listings_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (637,'2026_09_24_120001_create_marketer_conversations_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (638,'2026_09_24_120002_create_marketer_conversation_messages_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (639,'2026_09_24_150001_create_marketer_ad_packages_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (640,'2026_09_24_150002_create_marketer_ad_package_subscriptions_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (641,'2026_09_24_160001_create_marketer_documents_and_backfill_onboarding',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (642,'2026_09_24_170001_add_badge_delivery_time_to_shipping_methods_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (643,'2026_09_25_100001_add_badge_icon_to_shipping_methods_table',125);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (644,'2026_09_25_100002_backfill_shipping_badge_labels_from_name',126);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (645,'2026_09_25_100003_drop_delivery_labels_from_shipping_methods_table',127);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (646,'2026_09_24_000001_add_excluded_category_ids_to_marketer_commission_rules',128);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (647,'2026_09_26_100001_add_badge_icon_color_to_shipping_methods_table',128);
