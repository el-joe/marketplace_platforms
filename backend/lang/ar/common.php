...
return [
    ...
    'exceptions' => [
        ...
        'cart' => [
            ...
            'custom_attribute_invalid'   => 'قيمة غير صالحة لأحد خيارات المنتج.',
        ...
        'order' => [
            ...
            'not_bank_transfer'  => 'لم يتم إنشاء هذا الطلب بطريقة التحويل البنكي.',
        ...
        'checkout' => [
            ...
            'cod_international_not_allowed' => 'الدفع عند الاستلام غير متاح للمنتجات الدولية في سلتك. يرجى اختيار وسيلة دفع مسبق الدفع.',
            'international_shipping_ineligible' => 'لا يمكن شحن هذا المنتج إلى الدولة التي اخترتها.',
            ...
            'insufficient_wallet_balance' => 'رصيد محفظتك غير كافٍ لتغطية هذا الطلب. الرجاء شحن محفظتك أو اختيار طريقة دفع أخرى.',
            ...
            'coupon' => [
                'not_active' => 'هذا الكوبون لم يعد نشطًا.',
                'not_valid_now' => 'هذا الكوبون غير صالح في الوقت الحالي.',
                'country_not_eligible' => 'هذا الكوبون غير صالح في بلدك.',
                'currency_mismatch' => 'هذا الكوبون غير صالح لعملتك.',
                'min_order_not_reached' => 'طلبك لا يبلغ الحد الأدنى المطلوب لهذا الكوبون.',
                'not_stackable' => 'لا يمكن دمج هذا الكوبون مع خصم آخر.',
                'new_customers_only' => 'هذا الكوبون مخصص للعملاء الجدد فقط.',
                'not_eligible' => 'أنت غير مؤهل لاستخدام هذا الكوبون.',
                'usage_limit_reached' => 'وصل هذا الكوبون إلى الحد الأقصى للاستخدام.',
                'per_customer_limit_reached' => 'لقد استخدمت هذا الكوبون بالفعل الحد الأقصى من المرات المسموح بها.',
                'monthly_limit_reached' => 'لقد بلغت الحد الأقصى الشهري لاستخدام هذا الكوبون.',
                'shipping_type_restricted' => 'هذه القسيمة غير صالحة لنوع الشحن المحدد',
    ...
    'specialty_ar' => 'التخصص (عربي)',
    'specialty_en' => 'التخصص (إنجليزي)',
];
